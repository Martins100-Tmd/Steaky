  ...
  return (
    <>
      <div className="sm:w-ninety w-nineFive mx-auto rounded-t-xl p-10 flex sm:flex-row items-start bg-black flex-col">
        <div className="flex flex-col items-start w-full h-full mb-7">
          <div className="flex flex-row items-center gap-2 self-start">
            ...
            <span className="font-hev text-2xl text-white">Steaky Num</span>
          </div>
          <p className="text-base font-hev text-start self-center text-white my-5">
        ...
        <div className="flex flex-col sm:items-center items-start gap-5  w-full">
          <h1 className="text-2xl font-hev font-semibold mb-3 text-white uppercase ">
            RESOURCES
          </h1>
          <ul className="flex flex-col items-start gap-1 text-white">
            <li className="font-hev text-base font-semibold text-left">
              Application
            </li>
            <li className="font-hev text-base font-semibold text-left">
              Delivery
            ...
            <li className="font-hev text-base font-semibold text-left">FAQs</li>
          </ul>
        </div>
        <div className="flex flex-col sm:items-center items-start gap-5 sm:my-0 my-7">
          <h1 className="text-2xl font-hev font-semibold mb-3 text-white">
            Company
          </h1>
          <ul className="flex flex-col items-start gap-1 text-white">
            <li className="font-hev text-base font-semibold">About us</li>
            <li className="font-hev text-base font-semibold">Blogs</li>
            <li className="font-hev text-base font-semibold">Contacts</li>
            <li className="font-hev text-base font-semibold">Services</li>
          </ul>
        </div>
        <div className="flex flex-col sm:items-center items-start gap-5 w-full">
          <h1 className="text-2xl font-hev font-semibold mb-3 text-white uppercase">
      ...
      <footer className="p-3 sm:w-ninety w-nineFive mx-auto rounded-b-xl bg-green-400 text-center">
        <p className="text-base font-hev text-center">
