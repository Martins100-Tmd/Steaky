    ...
    <div className="flex flex-col items-center sm:w-ninety w-full mx-auto">
      ...
      >
        ...
        <div className="flex flex-col items-center absolute w-[75%] mx-auto left-[12%] top-[30%]">
          <h1 className="text-4xl text-center text-black font-b_serif self-center font-semibold">
            Steaky Num
          </h1>
          <p className=" font-pop text-lg self-center">
          ...
          return (
            <div className={`w-full flex ${item.flex} bg-slate-50`} key={index}>
              <div className="flex flex-col items-center w-[40%] bg-slate-50 p-4 self-stretch sm:self-center">
                <h1 className="text-2xl text-center pb-4 border-b-4 border-red-600 mb-5 font-pop font-semibold ">
                  {item.title}
                </h1>
                <p className="sm:text-sm text-xs text-center font-pop w-full mx-auto mt-5">
                  {item.text}
                </p>
              </div>
              <img
      ...
      <footer className="flex flex-row items-center w-full p-3 bg-black justify-between">
        <div className="flex flex-col items-start">
          <h1 className="text-xl text-center font-b_serif self-center font-semibold text-white">
            Steaky Num
          </h1>
          <p className=" font-pop text-sm self-center text-white">
            <i className="font-semibold fa text-sm mr-3">&#xf068;</i>
            Food & Tasty
            <i className="font-semibold fa text-sm ml-3">&#xf068;</i>
          </p>
      ...
      <div className="w-full bg-green-400 p-5 rounded-b-2xl">
        <p className="text-base font-b_serif text-center self-center">
